...
public class RobotMap {
 ...
 public static final double DISTANCE_PER_PULSE = Math.PI * WHEEL_DIAMETER / PULSES_PER_REVOLUTION;
  ...
  // Drive train sparks
	public static final int LEFT_1_VICTOR = 2;
	public static final int LEFT_2_VICTOR = 1;
	public static final int RIGHT_1_VICTOR = 5;
  public static final int RIGHT_2_VICTOR = 4;
